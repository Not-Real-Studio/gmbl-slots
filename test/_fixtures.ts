// Фикстуры тестов.
//
// SAMPLE — синтетический слот 5x3 под фикстуры оценки линии: пейтейбл и линии выдуманы,
// проверяется механика, а не конкретная игра.
//
...
export const SAMPLE: SlotSpec = {
  ...
  specialIds: [MONEY],
  paytable: {
    0: { 3: 250, 4: 500, 5: 1000 },
    20: { 3: 200, 4: 400, 5: 800 },
    21: { 3: 150, 4: 300, 5: 600 },
    10: { 3: 100, 4: 200, 5: 400 },
    11: { 3: 75, 4: 150, 5: 300 },
    1: { 3: 50, 4: 100, 5: 200 },
    2: { 3: 40, 4: 80, 5: 160 },
    3: { 3: 30, 4: 60, 5: 120 },
